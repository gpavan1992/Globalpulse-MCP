...
export function formatOutput(data: unknown, markdownFn: () => string, format: ResponseFormat): string {
...
export function formatDate(isoString: string): string {
  try { return new Date(isoString).toUTCString().replace(" GMT", " UTC"); } catch { return isoString; }
}
